...
UE.I18N['en'] = {
    ...
    'autoupload': {
        'exceedSizeError': 'Files Size Exceed',
        'exceedTypeError': 'Files Type Not Allow',
    ...
    'insertimage':{
        ...
        'uploadSelectFile':'Select Files',
        'uploadAddFile':'Add Files',
        ...
        'errorLoadConfig': 'Server config not loaded, upload can not work.',
        'errorExceedSize':'Files Size Exceed',
        'errorFileType':'Files Type Not Allow',
        'errorInterrupt':'Files Upload Interrupted',
    ...
    'insertvideo':{
        ...
        'fileSizeLimit':'Files size exceeds the limit！',
        'emptyFile':'Can not upload an empty file！',
        'fileTypeError':'Files type error！',
