...
(function( root, factory ) {
    ...
    define('file',[
         ...
         * @class File
         * @constructor 构造函数
         * @grammar new Files( source ) => Files
         * @param {Lib.Files} source [lib.Files](#Lib.Files)实例, 此source对象是带有Runtime信息的。
         */
        ...
        $.extend( WUFile.prototype, {
             ...
             * @param {File.Status|String} status [文件状态值](#WebUploader:Files:Files.Status)
    ...
    define('queue',[
        ...
        $.extend( Queue.prototype, {
            ...
            /**
             * 从队列中取出一个指定状态的文件。
             * @grammar fetch( status ) => Files
             * @method fetch
             * @param {String} status [文件状态值](#WebUploader:Files:Files.Status)
             * @return {File} [Files](#WebUploader:Files)
             */
            ...
            /**
             * 获取指定类型的文件列表, 列表中每一个成员为[Files](#WebUploader:Files)对象。
    ...
    define('widgets/queue',[
        ...
        return Uploader.register({
            ...
            init: function( opts ) {
                ...
                // 以至于外部添加原生 Files 对象的时候能正确包裹一下供 webuploader 使用。
                deferred = Base.Deferred();
            ...
            /**
             * @event filesQueued
             * @param {File} files 数组，内容为原始File(lib/Files）对象。
             ...
             * @param {Array of Files or Files} [files] Files 对象 数组
             * @description 添加文件到队列
             * @for  Uploader
             */
